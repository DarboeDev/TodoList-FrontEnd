...
const DeleteModal = ({setDeleteModal, currentTaskID, getAllTasks}) => {
  ...
  return (
    <div className='w-full h-screen bg-black/60 flex justify-center items-center fixed left-0 z-50 top-0 custom-shadow '>
    <div className={`flex flex-col ${darkMode ? "bg-dark-options" : 'bg-white'} px-10 py-6 gap-6`}>
            <h1 className={`text-lg ${darkMode && 'text-gray-200'} font-semibold`}>Are you sure you want to delete this task?</h1>
